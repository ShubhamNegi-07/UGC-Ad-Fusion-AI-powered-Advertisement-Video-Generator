...
graph TD
    ...
    D --> E["🧍 Avatar Generator\nAI Presenter Layer"]
    E --> F["🎥 Video Composer\nScript + Visuals + Audio"]
    F --> G["✅ Final Ad Output"]:::output
    G --> H["📱 Instagram Reels"]:::platform
    G --> I["🎵 TikTok"]:::platform
    G --> J["▶️ YouTube Shorts"]:::platform

    classDef input fill:#e94560,stroke:#c73652,color:#fff
    classDef ai fill:#533483,stroke:#3d2563,color:#fff
    classDef output fill:#0f9b58,stroke:#0a7a45,color:#fff
    classDef platform fill:#0f3460,stroke:#0a2540,color:#fff
```
